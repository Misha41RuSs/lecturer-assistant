...
## 2. Сервис трансляции и уведомлений (Lecture Broadcasting Service) [НОВЫЙ]
*Управляет жизненным циклом лекции (старт, стоп, текущий слайд) и подписками слушателей (присутствием). Отвечает за рассылку уведомлений (через TgBotApp или WebSocket).*
