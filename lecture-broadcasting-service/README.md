...
5. Настроить рассылку студентам: при смене слайда сервис должен итеративно пройтись по всем подписанным студентам в `broadcasting_db` и отправить им сообщения через Telegram-бот (через API бота или отдельную интеграцию).
